...
export default function UnifiedChat() {
  ...
  return (
    <div className="flex h-full flex-col bg-gradient-to-b from-[#06060a] to-[#040406]">
      ...
      {/* STREAM */}
      <div className="fb-no-scrollbar flex-1 space-y-5 overflow-y-auto px-6 py-5">
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {msg.thinking ? (
          ...
          <div className="text-[14px] leading-relaxed text-foreground/90">{msg.text}</div>
        )}
      </div>
    </motion.div>
  );
