...
# HostFlow AI NEXATECT™ — Manifesto (LOCKED Jun 18 2026)

## Rename (copyright-driven)
- ❌ OLD: Rapid Pay™
- ✅ NEW: **AneXVoT AI Pay™** — **A**utonomous **Ne**xt-Generation **V**el**o**city Orchestration **T**reasury

All product docs, code, UI strings, memory references → replace "Rapid Pay" with "AneXVoT AI Pay" going forward. Existing locked memory files retain Rapid Pay name for historical context but the live product = AneXVoT AI Pay.

## The 4 Sovereign Pillars

```
=====================================================================
                    HostFlow AI NEXATECT™
=====================================================================
Powered by:
...
communication, execution, payments, and business operations
work as a unified autonomous digital workforce.

[Workflow Path]: Intelligence → Execution → Revenue → Treasury
=====================================================================
```

## Pillar Roles
| Pillar | Domain | Engine |
|--------|--------|--------|
...
- aanris-runtime · axonetis-builder · axonetis-rust-human · hostflow-server · hostflowai-brain · runtime-schema-sync · schema-evolution
- Rust manifesto string saved at `/opt/hostflow-ecosystem/hostflow-server/src/manifesto.rs` as `BRAND_MANIFESTO`.
