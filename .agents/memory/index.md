...
MASTER blueprint LOCKED (see mem://features/builder-master-blueprint-LOCKED) — match line-by-line: UI layout, publish flow, killer features (Sherlock auto-fix max 3, multi-agent parallel, rollback, diff preview, cost meter, voice deploy), 8 DB tables.
...
## Memories
- [Phase 1 SQL Foundation](mem://features/phase1-sql-foundation) — `hetzner-migrations/20260612000001_phase1_foundation.sql` ready: 8 core + 7 hybrid mirror tables + roles + 6 seeded models. Run manually on Hetzner. Founder edits email placeholder in `handle_new_user()` before running.
